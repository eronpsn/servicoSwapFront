...
const Pendentes = () => {
  ...
  useEffect(() => {
    console.log('OK');
    const headers = {
      'x-token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1aWQiOiJjZjIwYmJhMS0yMTNjLTQ0MzItODIxOC0zOTg1OGMyOGVlNDEiLCJpYXQiOjE2OTYwNzg2NTEsImV4cCI6MTY5NjEyMTg1MX0.ygJUD5e2KeEwXOXCtfGjm_h3dE5QKayuB7EL9bzYvOw',
