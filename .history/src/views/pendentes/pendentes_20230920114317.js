...
const Pendentes = () => {
  ...
  <div className="col-auto justify-content-end  gap-2 mt-2" >
  <CButton color="primary" type='button' className='ml-20'>EXCLUIR</CButton>
  <CButton color="primary" type='button' className='ml-20'>EDITAR</CButton>
