...
const Pendentes = () => {
  ...
  useEffect(() => {
    console.log('OK');
    const headers = {
      'x-token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1aWQiOiJjZjIwYmJhMS0yMTNjLTQ0MzItODIxOC0zOTg1OGMyOGVlNDEiLCJpYXQiOjE2OTYxNjQ3MjEsImV4cCI6MTY5NjIwNzkyMX0.ZuFiya7K-DpJ0NIx0ONcxi33cuQr9bllFzNQaS7M_u8',
