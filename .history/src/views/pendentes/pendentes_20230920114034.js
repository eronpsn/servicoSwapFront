...
const Pendentes = () => {
  ...
  <div className="col-auto justify-content-end  gap-2 m-3">
  <CButton color="primary" type='button' className='ml-1'>EXCLUIR</CButton>
  <CButton color="primary" type='button' className='ml-4'>EDITAR</CButton>
